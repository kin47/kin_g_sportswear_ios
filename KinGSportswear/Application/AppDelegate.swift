...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func setupPushNotification() {
        ...
        UNUserNotificationCenter.current().delegate = NotificationService.instance
...
extension AppDelegate {
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable : Any]) {
        NotificationService.instance.received(notification: userInfo, application: application, isRemoteNoti: true)
    }
}
